...
export class SlackChannel implements Channel {
  ...
  private setupEventHandlers(): void {
    ...
    this.app.event('message', async ({ event }) => {
      ...
      const baseJid = buildSlackConversationJid(msg.channel);
      ...
      // Always report base-channel metadata for group discovery.
      this.opts.onChatMetadata(baseJid, timestamp, undefined, 'slack', isGroup);
      if (conversationJid !== baseJid) {
        // Thread conversations need their own chat metadata row so message
        // inserts satisfy the messages.chat_jid foreign key.
      ...
      this.opts.onMessage(conversationJid, {
        id: msg.ts,
